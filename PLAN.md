...
- [ ] Queued: OS selector in the Default picker to browse macOS/Linux system entries from Windows; verify on hardware whether the module firmware can emit Apple Fn (vendor page 0xFF00) — if not, Fn transport stays macOS-keyboard-only.
